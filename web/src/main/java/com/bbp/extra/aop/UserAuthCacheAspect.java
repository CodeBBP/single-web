...
import com.bbp.sys.auth.service.AuthService;
import com.bbp.sys.group.entity.Group;
import com.bbp.sys.group.entity.GroupRelation;
import com.bbp.sys.group.service.GroupRelationService;
import com.bbp.sys.group.service.GroupService;
 ...
 * <p/>
 * 1、当调用如下方法时，加缓存
 * {@link com.bbp.sys.auth.service.UserAuthService#findRoles}
 * {@link com.bbp.sys.auth.service.UserAuthService#findStringRoles}
 * {@link com.bbp.sys.auth.service.UserAuthService#findStringPermissions}
 * <p/>
 * 2、授权（Auth）
 * 当增删改授权时，
 * 如果是用户相关的，只删用户的即可，
...
public class UserAuthCacheAspect extends BaseCacheAspect {
     ...
     * 其他的全部清理
     */
    @Pointcut(value = "target(com.bbp.sys.auth.service.AuthService)")
     ...
     * 当删除权限时，清缓存
     */
    @Pointcut(value = "target(com.bbp.sys.permission.service.PermissionService)")
     ...
     * 当修改角色show/role/resourcePermissions关系时，清缓存
     */
    @Pointcut(value = "target(com.bbp.sys.permission.service.RoleService)")
     ...
     * 当删除/修改show字段时，清缓存
     */
    @Pointcut(value = "target(com.bbp.sys.organization.service.OrganizationService)")
     ...
     * 当删除/修改show字段时，清缓存
     */
    @Pointcut(value = "target(com.bbp.sys.organization.service.JobService)")
     ...
     * 当删除组时，清缓存
     */
    @Pointcut(value = "target(com.bbp.sys.group.service.GroupService)")
     ...
     * 其他情况，清所有
     */
    @Pointcut(value = "target(com.bbp.sys.group.service.GroupRelationService)")
     ...
     * 修改时，如果组织机构/工作职务变了，仅需清自己的缓存
     */
    @Pointcut(value = "target(com.bbp.sys.user.service.UserService)")
    ...
    @Pointcut(value = "target(com.bbp.sys.auth.service.UserAuthService)")
