 ...
 */
package com.bbp.sys.permission.entity;

import com.google.common.collect.Sets;
import com.bbp.common.entity.BaseEntity;
import com.bbp.common.repository.hibernate.type.CollectionToStringUserType;
...
/**
 * 包名：com.bbp.sys.permission.entity
 * <p>
 * 作者：mrbbp@qq.com
 * <p>
 * 创建时间：2018/3/14  9:45
 * <p>
 * 描述：此处没有使用关联 是为了提高性能（后续会挨着查询资源和权限列表，因为有缓存，数据量也不是很大 所以性能不会差）
 *
 */
