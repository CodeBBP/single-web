 ...
 * 配置方式
 * <p><filter>
 * <p><filter-name>TestFilter</filter-name>
 * <p><filter-class>com.sishuok.web.filter.TestFilter</filter-class>
 * <p><!-- url分隔符可以是 换行 空格 分号  逗号  白名单和黑名单都是可选-->
 * <p><init-param>
 * <p><param-name>blackListURL</param-name> <!-- 配置黑名单url 表示不走过滤器的url order：1 -->
 * <p><param-value>
 * <p>/aa
 * <p>/bb/**
 * <p>/cc/*
 ...
 * <p></init-param>
 * <p><init-param>
 * <p><param-name>whiteListURL</param-name> <!-- 配置白名单url 表示走过滤器的url order：2-->
 * <p><param-value>
 * <p>/dd;/ee,/ff /list
 * <p></param-value>
 * <p></init-param>
