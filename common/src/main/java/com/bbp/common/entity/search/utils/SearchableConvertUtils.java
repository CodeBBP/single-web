package com.bbp.common.entity.search.utils;

import com.google.common.collect.Lists;
import com.bbp.common.entity.search.SearchOperator;
import com.bbp.common.entity.search.Searchable;
import com.bbp.common.entity.search.exception.InvalidSearchPropertyException;
import com.bbp.common.entity.search.exception.InvalidSearchValueException;
import com.bbp.common.entity.search.exception.SearchException;
import com.bbp.common.entity.search.filter.AndCondition;
import com.bbp.common.entity.search.filter.Condition;
import com.bbp.common.entity.search.filter.OrCondition;
import com.bbp.common.entity.search.filter.SearchFilter;
...
/**
 * 包名：com.bbp.common.entity.search.utils
 * <p>
 * 作者：mrbbp@qq.com
 * <p>
 * 创建时间：2018/2/28  0:09
...
public final class SearchableConvertUtils {
     ...
     * value="com.bbp.common.entity.search.utils.SearchableConvertUtils.setConversionService"/>
                ...
                if (conversionService == null) {
                    try {
                        ...
                        throw new SearchException("conversionService is null, " +
                                ...
                                "please see [com.bbp.common.entity.search.utils." +
