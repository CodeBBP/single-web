...
/**
 * 包名：com.bbp.common.spring
 * <p>
 * 作者：mrbbp@qq.com
 * <p>
 * 创建时间：2018/3/10  22:17
 * <p>
 * 描述：加速spring启动，通过移除bean定义实现
 *
 */
public class SpeedUpSpringProcessor implements BeanFactoryPostProcessor {
    ...
    private boolean needRemove(String beanName, BeanDefinition beanDefinition) {
        ...
        //spring data jpa
        if(className.equals("com.bbp.common.repository.support.SimpleBaseRepositoryFactoryBean") ||
    ...
    public static void main(String[] args) {
        String c = "com.bbp.sys.user.web.bind.A";
